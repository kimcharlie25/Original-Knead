...
interface MenuProps {
  menuItems: MenuItem[];
  addToCart: (item: MenuItem, quantity?: number, variation?: any, addOns?: any[], bundleSelection?: Record<string, number>) => void;
  cartItems: CartItem[];
        ...
        return (
          <section key={category.id} id={category.id} className="mb-16">
            <div className="flex items-center mb-8">
              ...
              <h3 className="text-3xl font-more-sugar font-medium text-cookie-primary">{category.name}</h3>
            </div>
