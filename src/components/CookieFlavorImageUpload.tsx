...
import { useCookieFlavorImageUpload } from '../hooks/useCookieFlavorImageUpload';

interface CookieFlavorImageUploadProps {
  currentImage?: string;
  onImageChange: (imageUrl: string | undefined) => void;
  className?: string;
}

const CookieFlavorImageUpload: React.FC<CookieFlavorImageUploadProps> = ({ 
  currentImage, 
  onImageChange, 
  className = '' 
}) => {
  const fileInputRef = useRef<HTMLInputElement>(null);
  const { uploadImage, deleteImage, uploading, uploadProgress } = useCookieFlavorImageUpload();
...
export default CookieFlavorImageUpload;
